...
<div class='col-lg-10 col-lg-offset-1'>
    ...
    <div class="form-group">
        ...
        {{ Form::text('txtTitle', $page->title, array('class' => 'form-control')) }}
    </div>
    <div class="form-group">
        {{ Form::label('lblTitle', 'Meta KeyWord') }}
        {{ Form::text('txtmetakeyword', $page->metaKeyword, array('class' => 'form-control')) }}
    </div>
    ...
    <div class="form-group">
        ...
        {{ Form::select('lsttheme', $themes, $page->fkThemeId, ['class' => 'form-control']) }}
    </div>
