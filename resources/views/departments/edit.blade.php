...
<div class='col-lg-10 col-lg-offset-1'>
    ...
    {{ Form::model($stations, array('route' => array('departments.update', $departments->id), 'method' => 'PUT')) }}{{-- Form model binding to automatically populate our fields with user data --}}

    <div class="form-group">
        {{ Form::label('title', 'Title') }}
        {{ Form::text('title', $departments->title, array('class' => 'form-control')) }}
    </div>

    <div class="form-group">
        {{ Form::label('department type', 'Department Type') }}
        {{ Form::text('type', $departments->type, array('class' => 'form-control')) }}
    </div>
